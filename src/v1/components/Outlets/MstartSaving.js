      ...
      <div className="col-md-12 MstartSaving">
        <div className="row">
            ...
            <div className="SSCard">
              <div className="SSCard_content">
                <div className="SSCard_left">
                  <img src="https://b2cappassetscdn.theentertainerme.com/v7/standard/DXB-Standard-359x404.png" alt=" " />
                </div>
                <div className="SSCard_right">
                  ...
                  <div class="New_Product_Tiers_pricebox">
                    <div class="New_Product_Tiers_price">
                      61.25
                      <small>
                        AED <span>/month</span>
                      </small>
                    </div>
                    <div class="New_Product_Tiers_priceannually">
          ...
          <div className="col-md-6 card_offers">
            ...
            <img
              src="https://b2cappassetscdn.theentertainerme.com/website_images/card_offer1.svg"
              alt="Offer"
            />
            <img
              src="https://b2cappassetscdn.theentertainerme.com/website_images/card_offer3.svg"
              alt="Offer"
            />
          </div>
        </div>
